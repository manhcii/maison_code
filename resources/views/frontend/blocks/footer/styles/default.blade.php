                            ...
                            <div class="blocklogo">
                                <a href="index.html" class="logofooter">
                                    <img width="270" height="75"
                                        src="{{ $web_information->image->logo_footer ?? '' }}" alt="Logo footer" />
                                </a>
                            </div>
                            ...
                            <div class="contactfooter">
                                <div class="flop mt">
                                    <div class="section clearfix">
                                        ...
                                        <div class="fright">
                                            <span>{!! $web_information->information->address ?? '' !!}</span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-8 col-lg-8 col-12">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-12 mail_footer">
                                <div class="mail_img">
                                    <img class="lazyload" width="64px" src="{{ asset('images/load.gif') }}"
                                        data-src="{{ asset('images/ic-mail.png') }}" alt="Template Big Green" />
                                </div>
                                ...
                                <div class="form-footer">
                                    <div class="form-wrapper columns_margin_bottom_20 columns_padding_15">
                                        <div class="mail_footer subscribe">
                                            <form id="mc-form" action="{{ route('frontend.contact.store') }}" class="form_ajax newsletter-form"
