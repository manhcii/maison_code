            ...
            var i = [],
                ...
                d = function (e) {
                    ...
                    i.push(e),
                        ...
                        c(s) &&
                            (o !== n &&
                                o.call(null, { entering: a, exiting: l }),
                            (t[i.length - 1] = !0));
                },
                u = function () {
                    ...
                    for (
                        var g = { entering: a, exiting: l }, f = 0;
                        f < s.length;
                        f++
                    )
                        s[f].call(null, g);
    ...
    (SEMICOLON.initialize = {
            ...
            i || (i = 700),
                ...
                X.off("click").on("click", function () {
                    return (
                        e("body,html")
                            .stop(!0)
                            .animate({ scrollTop: 0 }, Number(i), n),
                        !1
                    );
                });
        },
        goToTopScroll: function () {
            ...
            if (
                (i || (i = 450),
                "true" != e &&
                    (o.hasClass("device-sm") || o.hasClass("device-xs")))
            )
                return !0;
            ...
            return (
                ...
                SEMICOLON.isMobile.any()
                    ...
                    : ((e = d.hasClass("sticky-header")
                          ...
                          : 184),
                      $.length ||
                          (e = d.hasClass("sticky-header") ? 100 : 140)),
                e
            );
        },
        ...
        (SEMICOLON.header = {
            ...
            initialize: function () {
                u.length > 0 &&
                    ...
                    e(".menu-item:has(.sub-menu-container)").addClass(
                        "sub-menu"
                    ),
                    e(
            ...
            fullWidthMenu: function () {
                if (
                    ...
                    return (
                        e(".mega-menu-content, .top-search-form").css({
                            width: "",
                        }),
                        !0
                    );
                ...
                if (
                    ...
                    let i = e(
                        ...
                        n =
                            ...
                            (u.outerHeight() -
                                i.parents(".header-row").outerHeight()) +
                            "px ); }",
                        t =
                            document.head ||
            ...
            sideHeader: function () {
                e("#header-trigger")
                    ...
                    .on("click", function () {
                        return (
                            e("body.open-header").toggleClass(
                                "side-header-open"
                            ),
                            !1
                        );
            ...
            sidePanel: function () {
                e(".side-panel-trigger")
                    ...
                    .on("click", function () {
                        return (
                            o.removeClass("side-panel-open-signup"),
                ...
                e(".side-panel-trigger-signup")
                    .off("click")
                    .on("click", function () {
                        return (
                            o.removeClass("side-panel-open"),
                            o.toggleClass("side-panel-open-signup"),
                            o.hasClass("device-touch") &&
                                o.hasClass("side-push-panel") &&
                                o.toggleClass("ohidden"),
                            !1
            ...
            logo: function () {
                let e = j.find("img"),
                    i = P.find("img");
                (!d.hasClass("dark") && !o.hasClass("dark")) ||
                u.hasClass("not-dark")
            ...
            miscFunctions: function () {
                ...
                e(document).on("click", function (t) {
                    e(t.target).closest(".top-search-form").length ||
                        ...
                        e(t.target).closest("#side-panel-signup").length ||
                            o.toggleClass("side-panel-open-signup",!1),
        ...
        (SEMICOLON.slider = {
            ...
            sliderDimensions: function () {
                ...
                if (o.hasClass("device-xl") || o.hasClass("device-lg")) {
                    if (
                        ...
                        (e.hasClass("container") ||
                            e.hasClass("container-fluid")) &&
                            (e = e.children().first()),
            ...
            sliderParallaxOffset: function () {
                ...
                return (
                    (o.hasClass("side-header") ||
                        d.next(".include-header").length > 0) &&
                        (i = 0),
            ...
            subscription: function (e) {
                let i = {
                    ...
                    n = {
                        ...
                        pluginfn:
                            'typeof scwSubscribeFormPlugin !== "undefined"',
            ...
            extras: function () {
                let i = setInterval(function () {
                    "pluginBootstrapReady" in scwEvents &&
                        ...
                        e().popover
                            ? e('[data-bs-toggle="popover"]').popover({
                                  container: "body",
                              })
                            : console.log(
                        ...
                        s = function (e) {
                            e
                                ? (o.toggleClass("dark", !0),
                                  i.removeClass(n).addClass(t))
                                : (o.toggleClass("dark", !1),
                                  i.removeClass(t).addClass(n)),
                                SEMICOLON.header.logo();
                        };
                    window.matchMedia &&
                        (s(
                ...
                let n = location.hash;
                e(n).length > 0 &&
                    e(".one-page-menu").find('[data-href="' + n + '"]').length >
                        0 &&
                    l.scrollTop(0);
            },
        }),
